<%-- 
    Document   : Login
    Created on : 29/10/2019, 13:53:22
    Author     : Pedro Portes
--%>
...
<html>
  ...
  <link rel="stylesheet" href="https://static.pingendo.com/bootstrap/bootstrap-4.3.1.css">
    ...
    <body>
        <div class="py-5 text-center" style="	background-image: url(https://pingendo.com/site-assets/cover.jpg);	background-size: 100%;	background-position: top left;	background-repeat: repeat;">
    <div class="container">
      <div class="row" >
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          <p class="mt-2 mb-0">© 2014-2018 IF Goiano. All rights reserved</p>
        </div>
      </div>
    </div>
  </div>
