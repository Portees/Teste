...
public class TrechoJpaController implements Serializable {
    ...
    public TrechoJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(Trecho trecho) throws RollbackFailureException, Exception {
    ...
    public void edit(Trecho trecho) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
