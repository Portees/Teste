    ...
    <div class="container">
      <div class="row" style="">
        <div class="mx-auto col-lg-6 col-10">
          ...
          <form class="text-left" action="Cadastro" method="post">
            <div class="form-group"> <label for="form16" contenteditable="true">Nome Completo:</label> <input type="text" class="form-control" id="nome"> </div>
            <div class="form-group"> <label for="form17">Email:&nbsp;</label> <input type="text" class="form-control" id="email" placeholder="exemplo@gmail.com"> </div>
            <div class="form-group"> <label for="form18">Confirme seu Email:</label> <input type="email" class="form-control" id="form18"> </div>
            <div class="form-row">
              <div class="form-group col-md-6"> <label for="form19">Senha</label> <input type="password" class="form-control" id="senhaa" placeholder="••••"> </div>
